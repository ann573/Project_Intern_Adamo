  ...
  return (
    <div className=' border-b border-[#e5e5e59b] py-10'>
      <div className='flex gap-5'>
        <img src={data.avatar} alt='avt_review' className='w-20 rounded-full h-fit' />
        <div>
          <div className='flex gap-2 text-primary font-semibold'>
            Rating {data.rating} <span className='mx-2 text-[#C4C4C4]'> • </span>
          ...
          <p className='text-color-content-second'>
            {data.name} <span className='mx-2 text-[#C4C4C4]'> • </span> {monthName} {yearName}
          </p>
        </div>
      </div>
