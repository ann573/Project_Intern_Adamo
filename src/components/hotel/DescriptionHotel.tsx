                    ...
                    {Array.isArray(item.facilities) && (
                      <>
                        ...
                        {item.facilities.length > 4 && (
                          <span>
                            {' '}
                            • <span className='text-[#04316A] font-semibold'>{item.facilities.length - 4} more</span>
                          </span>
                        )}
                      </>
                    )}
                ...
                <DialogContent className='sm:w-[90%] sm:max-w-[2000px] max-h-[90vh] overflow-y-auto'>
                  ...
                  <DialogDescription className='grid md:grid-cols-2 grid-cols-1 gap-10 text-black'>
                    <div>
                      <div className='flex justify-between items-center mb-5'>
                        <div className='text-xs text-[#5E6D77]'>
                          ...
                          <span className='text-red-500 text-xl font-bold'> ${item.price_discount}</span> /night
                        </div>
                        <Button
                          className={`px-8 py-2 ${
                            item.isAvailable
                    ...
                    <div>
                      ...
                      <p className='text-heading leading-8'>{item.description}</p>

                      <hr className='my-3' />

                      <h3 className='font-bold text-lg mb-5 text-heading'>Room Facilities: </h3>
                      <div className='max-h-80 overflow-y-auto columns-2'>
                        {item.facilities.map((item) => {
                          return (
                            <div key={item} className='flex gap-2 items-center  mb-2 '>
