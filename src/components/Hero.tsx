        ...
        <div className="flex gap-7">
          ...
          <div className="text-content flex flex-col gap-5">
            <p>
              ...
              rerum quos. Maiores ipsa obcaecati dignissimos quaerat repellendus
              reprehenderit temporibus, ex sunt sit nulla debitis quis fugiat.
              Sequi ullam eveniet corrupti ut, accusamus aspernatur odio
              excepturi vel maxime tenetur.
            </p>

            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel
              dolorum voluptate quas reiciendis ad officia vitae aspernatur
              voluptatum et voluptatibus, natus ratione voluptates iure expedita
              consequatur est nostrum aliquam molestiae?
            </p>
          </div>
        </div>
      </div>
